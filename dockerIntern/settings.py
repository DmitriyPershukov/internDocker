"""
Django settings for dockerIntern project.
Generated by 'django-admin startproject' using Django 2.2.15.hh
...
ROOT_URLCONF = 'dockerIntern.urls'
...
WSGI_APPLICATION = 'dockerIntern.wsgi.application'
